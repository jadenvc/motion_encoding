...
class Net(nn.Module):
    ...
    def forward(self, data: Dict) -> Dict[str, List[Tensor]]:
        ...
        # prediction
        if "no_last_layer" not in self.config or not self.config["no_last_layer"]:
        ...
        out = {"actors": actors, "actor_idcs": actor_idcs, "actor_ctrs": actor_ctrs, "n_actor": self.config["n_actor"]}
        return out
